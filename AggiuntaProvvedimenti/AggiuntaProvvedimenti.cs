...
namespace ProcedureNet7
{
    internal class AggiuntaProvvedimenti : BaseProcedure<ArgsAggiuntaProvvedimenti>
    {
        ...
        public override void RunProcedure(ArgsAggiuntaProvvedimenti args)
        {
            try
            {
                ...
                foreach (string excelFilePath in excelFilePaths)
                {
                    ...
                    HandleSpecificheImpegni(allStudentsData, numProvvedimento, aaProvvedimento, dataProvvedimento, provvedimentoSelezionato, notaProvvedimento);
        ...
        private void HandleSpecificheImpegni(DataTable allStudentsData, string numProvvedimento, string aaProvvedimento, string dataProvvedimento, string provvedimentoSelezionato, string notaProvvedimento)
        {
